...
document.addEventListener('DOMContentLoaded', function(e) {
	...
	*/
	...
	document.querySelector('.promoBar-wrapper').innerHTML =
	'<div class="promo-text">\
		<span>Q2A plugin, AI Voice Commander is now out!</span>\
		<a class="learn-more" href="https://rxchun.github.io/shop/voice-commander" style="color:#ffffff">Learn more</a>\
	</div>'
	;
